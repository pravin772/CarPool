...
if (empty($_POST)) {
    ...
    if ($missing_fields) {
        ...
        user\add_user($user_data,$connection);
        user\authenticate_user($user_data['email_address'], $user_data['password'], $connection);
        $status = 'Success!';
        $msg = 'You have successfully registered for Car Pool!';
    }
}
