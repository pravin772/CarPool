...
$GLOBALS['connection'] = mysqli_connect($dbhost, $dbuser, $dbpass);
if (!$GLOBALS['connection']) {
    die('Could not connect: ' . mysql_error());
}
mysqli_select_db($GLOBALS['connection'], $dbname) or die(mysql_error());

function sanitize_string($var,$connection)
{
    $var = strip_tags($var);
